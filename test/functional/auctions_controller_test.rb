...
class AuctionsControllerTest < ActionController::TestCase
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post :create, auction: { description: @auction.description, max_bids: @auction.max_bids, process_id: @auction.process_id, url: @auction.url, user_id: @auction.user_id }
    end
  ...
  test "should update auction" do
    put :update, id: @auction, auction: { description: @auction.description, max_bids: @auction.max_bids, process_id: @auction.process_id, url: @auction.url, user_id: @auction.user_id }
    assert_redirected_to auction_path(assigns(:auction))
  end
